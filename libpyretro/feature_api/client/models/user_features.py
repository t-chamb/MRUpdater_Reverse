...
# File: user_features.pyc (Python 3.10)
...
class UserFeatures(BaseModel):
    ...
    UserFeatures
    '''
    user_id: 'Optional[StrictStr]' = Field(None, 'The ID of the user', **('default', 'description'))
    feature_ids: 'Optional[List[StrictStr]]' = Field(None, 'The IDs of the features that are accessible to the user', **('default', 'description'))
